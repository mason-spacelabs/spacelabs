...
var collectData = function(customer, update){
    ...
    for (var i = 0; i < parent.length; i++) {
        var productNames = parent[i].attributes["4"].value; // Product names for MFG PRO
        var productIdentifiers = parent[i].attributes["2"].value; // Product Identifiers for API Admin Post
...
var spacelabsPricing = function(parameters, update) {
    ...
    $.ajax({
        url: "https://67b2bc0a.ngrok.io/spacelabs/pricing", 
        type: "POST",
        crossDomain: true,
        data: parameters,
        dataType: "json",
...
var submitRequest = function(form) {
    ...
    var promise = new Promise(function(resolve, reject){
        ...
        $.ajax({
            url: "https://67b2bc0a.ngrok.io/spacelabs/register",  
            type: "POST",
            crossDomain: true,
            data: form,
            dataType: "json",
