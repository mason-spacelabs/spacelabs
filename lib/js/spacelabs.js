...
var NGROK = "https://43b077ea.ngrok.io";  
...
var collectData = function(customer, update){
    ...
    var parent = document.getElementsByClassName('cart-item'); // Grabbing cart content
    var productArray = []; // Request string contents
    var ShopifyCustomer = {
        ShopifyCustomerNumber: customer.customer, 
        ShopifyFacilityNumber: customer.facility,
        ShopifyShippingNumber: customer.shipping,
        Variants: {
        }
    }; 
    ...
    var requestParameters = customer.facility + "&" + productList; // Creating the request string for MFG PRO
