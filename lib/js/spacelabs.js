...
$("#facility_same_as_billing").on("change", function(){
  ...
  function openModal() {
    $("#modal-login").addClass("show-modal").fadeIn(300); 
    $("#modal-login").removeClass("hidden-modal");
  }
  function closeModal() {
      console.log("working");
      $("#modal-login").removeClass("show-modal");
    $("#modal-login").addClass("hidden-modal").fadeOut(300);
  }
