...
// Register Form Post to Private Server

// function registerPOST(form) {
//     $.ajax({
//         url: "https://0af153ca.ngrok.io/spacelabs/register", 
//         type: "POST",
//         crossDomain: true,
//         data: form,
//         dataType: "json",
...
$(".next").click(function(){
    ...
    form.validate({
        ...
        submitHandler: function (form) {
            ...
            firstMethod(register_data).then(null,form.submit());

            // var register_data = $("#contact_form").serialize();
            // registerPOST(register_data);
            // form.submit();
